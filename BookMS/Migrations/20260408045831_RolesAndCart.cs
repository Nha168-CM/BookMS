...
{
    /// <inheritdoc />
    public partial class RolesAndCart : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StockTransactions_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 4, 8, 11, 58, 26, 846, DateTimeKind.Local).AddTicks(3447), "", "Action" },
                    { 2, new DateTime(2026, 4, 8, 11, 58, 26, 846, DateTimeKind.Local).AddTicks(3469), "", "Fantasy" },
                    { 3, new DateTime(2026, 4, 8, 11, 58, 26, 846, DateTimeKind.Local).AddTicks(3470), "", "Drama" },
                    { 4, new DateTime(2026, 4, 8, 11, 58, 26, 846, DateTimeKind.Local).AddTicks(3472), "", "Adventure" },
                    { 5, new DateTime(2026, 4, 8, 11, 58, 26, 846, DateTimeKind.Local).AddTicks(3474), "", "Animation" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockTransactions_CategoryId",
                table: "StockTransactions",
                column: "CategoryId");
